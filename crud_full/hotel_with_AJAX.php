...
<script>
    ...
    $('.edit-hotel-name').on('click', function() {
        ...
        $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'get_hotel_name',
                    hotel_name_id: id,
                    saveHotelName: $('#saveHotelName').val()
                },
            })
            .done(function(response) {
                if (response.success) {
                    $("[name=hotel_name]").val(response.data.hotel_name.name);
                }
            })
            .fail(function() {
                console.log("error");
...
class OpsDashAjaxAction
{
	...
	public function getRoom()
	{
        ...
        OpsAuthorization::dashboard(get_current_user_id());
	...
	public function getName()
	{
        ...
        $hotel_name_id = intval($_POST['hotel_name_id']); //get['hotel_name_id'] from ajax data : { hotel_name_id: $(this).data('id'), }
